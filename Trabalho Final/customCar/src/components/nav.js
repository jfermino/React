        ...
        return (
            <nav className="nav-global">
                <ul className="nav justify-content-center">
                    ...
                    <li className="nav-item">
                        <Link to="/opcionais" className="nav-link"><i className="fas fa-cart-arrow-down"></i>Seleção Opcionais</Link>
                    </li>
                    <li className="nav-item">
                        <Link to="/resumo" className="nav-link"><i className="fas fa-cart-arrow-down"></i>Resumo</Link>
                    </li>
                </ul>
            </nav>
        )
